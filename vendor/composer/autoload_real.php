...
class ComposerAutoloaderInit3d658f175f3ff751fc6af09125f6bf70
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit3d658f175f3ff751fc6af09125f6bf70::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire3d658f175f3ff751fc6af09125f6bf70($fileIdentifier, $file);
        }
...
function composerRequire3d658f175f3ff751fc6af09125f6bf70($fileIdentifier, $file)
{
