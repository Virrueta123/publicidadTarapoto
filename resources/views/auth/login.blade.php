            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <a href="{{ route("login")}}" class="h1"><b>Publicidad</b> Tarapoto <strong class="text-info">Sistema</strong> </a>
                        </div>
                        <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <input placeholder="usuario" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
