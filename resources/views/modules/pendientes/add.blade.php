    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form id="formPedientes" method="POST" action="{{ route("Pendientes.store") }}">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <div class="input-group mb-3">
                            <textarea class="form-control" name="Pex_Desc" rows="3" placeholder="ecribir ..."></textarea>
                        </div>
                     </div> 
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        <label>Cliente</label>
                        <div class="input-group mb-3">
                            <select name="Clx_Id"  class="form-control select" id="cbxCliente"> 
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <div class="input-group mb-3">
                            <input type="date" class="form-control" name="Pex_Fecha">
