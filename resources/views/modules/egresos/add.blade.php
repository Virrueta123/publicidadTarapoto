    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form id="formEgresos" method="POST" action="{{ route("Egresos.store") }}">
            @csrf
            <div class="card-body">
              <div class="form-group">
                    <label for="Egx_Desc">Descripcion <code>*obligatorio</code></label>
                    <input type="text" name="Egx_Desc" class="form-control form-control-border"    >
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group mb-6 group-symbol">
                    ...
                    <input type="number" name="Egx_Monto" class="form-control form-control-border" id="Egx_Monto"  > 
